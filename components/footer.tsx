...
export const  Footer= ()=>  {
    ...
    return (
        <footer className="text-text-blackgrey bg-neutral-100/90 shadow-md border-t-2 rounded-t-md border-neutral-400/95 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8 mt-2">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <img src="/logo.png" className=" size-20 sm:mx-auto" />
                <p className="leading-relaxed mt-2 text-[15px]">
                  Apartamenti is an application built by 
                  <span className=" hover:underline mx-2 text-blue-france font-semibold hover:cursor-pointer">
                  <a href="https://x.com/roy_weru" target="_blank">
                    Roy weru
                  </a>
                  </span>
                  to enable users to find their perfect home for rent or buy
                </p>
            </div>
